...
import { addingcouriers, updatecouriers } from "../../services/courier_service";
import "react-toastify/dist/ReactToastify.css";
import { ToastContainer, toast } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";

function Updatecourier(props) {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(courier);
    updatecouriers(courier.courier_id, courier)
      .then((res) => {
        console.log(res);
        notify();
      })
